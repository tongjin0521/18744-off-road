...
learn.load('1.5-stage-2-weights')
#CUDA_LAUNCH_BLOCKING=1

lr_find(learn)
learn.recorder.plot()
plt.savefig('1.5-loss_plot_with_weights-more.png')
...
learn.save('1.5-stage-2-weights-more')
...
plt.savefig('1.5-global_confusion_with_weights-more.png')
